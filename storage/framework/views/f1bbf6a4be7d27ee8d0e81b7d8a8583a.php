...
<?php $component->withAttributes(['title' => 'Tambah Anggota','maxWidth' => 'md','scrollable' => true,'showTitle' => true]); ?>
     <?php $__env->slot('trigger', null, []); ?> 
        <button
            class="inline-flex items-center px-2 py-1.5 text-sm font-medium text-white bg-green-700 border border-transparent rounded-md hover:bg-green-800">
    ...
    <form method="POST" action="<?php echo e(route('anggota.store')); ?>" class="space-y-3">
        <?php echo csrf_field(); ?>
        ...
        <div x-data="{ open: false, jenis: '<?php echo e(old('jenis_ternak') ? old('jenis_ternak') : ''); ?>' }" class="relative">
            <label class="block text-xs font-medium text-gray-600">Jenis Ternak</label>
        ...
        >
            ...
            <div>
                <label class="block text-xs font-medium text-gray-700">Jumlah Induk</label>
                    ...
                    <div class="relative w-full mt-1"> 
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center gap-0.5 pr-1.5">
                            ...
                            <button type="button" 
                                    ...
                                    class="flex items-center justify-center w-4 h-4 text-gray-600 bg-white border border-gray-300 rounded-full hover:bg-gray-100 active:bg-gray-200 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
            ...
            <template x-for="index in jumlahInduk" :key="index">
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Rp 0"
                        class="block w-full mt-1 text-xs text-gray-800 border-gray-200 rounded-md shadow-sm focus:ring-0 focus:border-green-500"
                    >
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div>
                <label class="block text-xs font-medium text-gray-600">No HP</label>
        ...
        <div>
            <label class="block text-xs font-medium text-gray-600">Lokasi Kandang</label>
...
<?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/components/anggota/create-modal.blade.php ENDPATH**/ ?>