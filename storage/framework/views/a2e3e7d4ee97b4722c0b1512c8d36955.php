...
<?php $component->withAttributes(['title' => 'Konfirmasi Hapus','maxWidth' => 'sm','scrollable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'showTitle' => true]); ?>
    ...
    <form method="POST" action="<?php echo e(route('anggota.destroy', $anggota->id)); ?>">
        ...
        <input type="hidden" name="tahap_id" value="<?php echo e(request('tahap_id')); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\Dewa Juli\Documents\My Project\Proyek Sipaten\sipaten\resources\views/components/anggota/delete-modal.blade.php ENDPATH**/ ?>