        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Menampilkan semua file arsip pada tahun <span class="font-bold"><?php echo e($tahun); ?></span></p>
                </div>

                
                <form id="form-validasi" action="<?php echo e(route('arsip.validasi', ['tahun' => $tahun])); ?>" method="POST" class="hidden">
                    <?php echo csrf_field(); ?>
                </form>

                
                <button type="button" id="btn-validasi"
                        class="flex items-center justify-center space-x-2 bg-green-600 text-white hover:bg-green-700 font-medium text-sm px-4 py-2 rounded-md transition">
                        ...
                        <div class="flex flex-col justify-between transition bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md">
                            ...
                            <div class="p-5">
                                <h3 class="mb-2 text-lg font-semibold text-gray-800 truncate">
                                    <?php echo e($arsip->nama_file); ?>

                                </h3>
                                <div class="flex items-center justify-between mt-4 text-sm text-gray-500">
                                    <span class="px-2 py-1 font-medium bg-gray-100 rounded">
                                        <?php echo e(\Carbon\Carbon::createFromFormat('!m', $arsip->bulan)->translatedFormat('F')); ?>
                            ...
                            <div class="flex items-center justify-end px-5 py-3 space-x-4 bg-gray-50 border-t">
                                <a href="<?php echo e(route('arsip.show', $arsip->id)); ?>" target="_blank" class="text-sm font-medium text-blue-600 hover:text-blue-800">Lihat</a>

                                
                                <form id="form-hapus-<?php echo e($arsip->id); ?>" action="<?php echo e(route('arsip.destroy', $arsip->id)); ?>" method="POST" class="hidden">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                </form>
                                
                                
                                <button type="button" class="btn-hapus text-sm font-medium text-red-600 hover:text-red-800" data-arsip-id="<?php echo e($arsip->id); ?>">
                                    Hapus
                                </button>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="py-12 text-center text-gray-500">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Saat ini belum ada laporan yang diarsipkan pada tahun <?php echo e($tahun); ?>.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/arsip-bulan.blade.php ENDPATH**/ ?>