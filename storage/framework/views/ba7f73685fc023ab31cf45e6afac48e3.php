...
<?php $component->withAttributes(['title' => 'Edit Anggota','maxWidth' => 'md','scrollable' => true,'showTitle' => true]); ?>
    ...
    <form method="POST" action="<?php echo e(route('anggota.update', $anggota->id)); ?>" class="space-y-3">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/components/anggota/edit-modal.blade.php ENDPATH**/ ?>