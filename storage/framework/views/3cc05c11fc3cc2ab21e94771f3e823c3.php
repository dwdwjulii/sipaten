                                ...
                                <ul class="max-h-60 overflow-y-auto text-xs text-gray-700">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('pencatatan.index', ['tahap_id' => $tahap->id])); ?>"
                                            class="block px-3 py-2 break-words text-xs hover:bg-green-100 hover:rounded-lg whitespace-normal <?php if($tahapDipilih && $tahapDipilih->id == $tahap->id): ?> bg-green-100 <?php endif; ?> ">
                                        ...
                                        <div x-data="{ open: false }" @click.away="open = false" class="relative inline-block text-left">
                                            ...
                                            <div x-show="open"
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    ?>
                                                    <a href="<?php echo e(build_filter_url('status_laporan', '')); ?>" class="block w-full px-4 py-2 text-xs text-left text-gray-700 hover:bg-gray-100 <?php echo e(!request('status_laporan') ? 'bg-gray-100 font' : ''); ?>">
                                                        Semua Laporan
                                                    </a>
                                                    <a href="<?php echo e(build_filter_url('status_laporan', 'sudah')); ?>" class="block w-full px-4 py-2 text-xs text-left text-gray-700 hover:bg-gray-100 <?php echo e(request('status_laporan') == 'sudah' ? 'bg-gray-100' : ''); ?>">
                                                        Sudah Dicatat
                                                    </a>
                                                    <a href="<?php echo e(build_filter_url('status_laporan', 'belum')); ?>" class="block w-full px-4 py-2 text-xs text-left text-gray-700 hover:bg-gray-100 <?php echo e(request('status_laporan') == 'belum' ? 'bg-gray-100' : ''); ?>">
                                                        Belum Dicatat
                                                    </a>
                                                </div>
                                            </div>
...
<?php /**PATH C:\Users\Dewa Juli\Documents\My Project\Proyek Sipaten\sipaten\resources\views/pencatatan.blade.php ENDPATH**/ ?>