                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="ternaks[<?php echo e($indukDetail->id); ?>][umur_ternak]" value="<?php echo e(old('ternaks.'.$indukDetail->id.'.umur_ternak', $indukDetail->umur_saat_dicatat)); ?>" class="mt-1 block w-full border-gray-300 placeholder:text-red-500 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs" placeholder="Contoh: 6 bulan">
                                                        </div>
                                                        <div>
...
<?php endif; ?><?php /**PATH C:\Users\Dewa Juli\Documents\My Project\Proyek Sipaten\sipaten\resources\views/petugas/pencatatan-edit.blade.php ENDPATH**/ ?>