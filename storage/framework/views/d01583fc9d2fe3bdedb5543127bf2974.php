...
<?php $component->withAttributes([]); ?>
        ...
        <div class="py-2">
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                ...
                <form id="pencatatan-form" action="<?php echo e(route('pencatatan.update', $pencatatan->id)); ?>" method="POST"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <div class="p-3 bg-gray-100 border border-gray-200 rounded-md text-gray-900">
                                            <?php echo e($anggota->nama); ?></div>
                                    </div>
                                    <div>
                                        <label class="block font-medium text-gray-700 mb-1">Tahap</label>
                                        <div class="p-3 bg-gray-100 border border-gray-200 rounded-md text-gray-900">
                                            <?php echo e($anggota->tahap?->label ?? 'Tidak ada tahap'); ?></div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="p-3 bg-gray-100 border border-gray-200 rounded-md text-gray-900">
                                            <?php echo e($anggota->ternaks()->where('tipe_ternak', 'Induk')->where('status_aktif', 'aktif')->count()); ?> ekor</div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="p-3 bg-gray-100 border border-gray-200 rounded-md text-gray-900">Rp
                                            <?php echo e(number_format($anggota->total_harga_induk ?? 0, 0, ',', '.')); ?></div>
                                    </div>
                                    <div>
                                        <label class="block font-medium text-gray-700 mb-1">Lokasi Kandang</label>
                                        <div class="p-3 bg-gray-100 border border-gray-200 rounded-md text-gray-900">
                                            <?php echo e($anggota->lokasi_kandang); ?></div>
                                    </div>
                                ...
                                <?php $__currentLoopData = $groupedDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="bg-white shadow rounded-lg ternak-group mb-4">
                                            ...
                                            <div class="p-4 border-b border-gray-200">
                                                <div class="flex justify-between items-center">
                                                    <h3 class="text-lg font-semibold text-gray-900">Data Induk #<?php echo e($group['group_index']); ?></h3>
                                                    <button type="button" onclick="addAnak('<?php echo e($indukDetail->ternak->id); ?>', <?php echo e($group['group_index']); ?>)"
                                            ...
                                            <div class="p-6">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <input type="hidden" name="ternaks[<?php echo e($indukDetail->id); ?>][detail_id]" value="<?php echo e($indukDetail->id); ?>">
                                                    
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Tipe Ternak</label>
                                                            <select name="ternaks[<?php echo e($indukDetail->id); ?>][tipe_ternak]" 
                                                                ...
                                                                <option value="Induk" <?php echo e($indukDetail->ternak->tipe_ternak == 'Induk' ? 'selected' : ''); ?>>Induk</option>
                                                                <option value="Anak" <?php echo e($indukDetail->ternak->tipe_ternak == 'Anak' ? 'selected' : ''); ?>>Anak</option>
                                                            </select>
                                                        </div>
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Jenis Kelamin</label>
                                                            <select name="ternaks[<?php echo e($indukDetail->id); ?>][jenis_kelamin]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                <option value="Jantan" <?php echo e($indukDetail->ternak->jenis_kelamin == 'Jantan' ? 'selected' : ''); ?>>Jantan</option>
                                                                <option value="Betina" <?php echo e($indukDetail->ternak->jenis_kelamin == 'Betina' ? 'selected' : ''); ?>>Betina</option>
                                                            </select>
                                                        </div>
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">No Ear Tag</label>
                                                            <select name="ternaks[<?php echo e($indukDetail->id); ?>][no_ear_tag]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                <option value="Ada" <?php echo e($indukDetail->ternak->no_ear_tag == 'Ada' ? 'selected' : ''); ?>>Ada</option>
                                                                <option value="Tidak Ada" <?php echo e($indukDetail->ternak->no_ear_tag == 'Tidak Ada' ? 'selected' : ''); ?>>Tidak Ada</option>
                                                            </select>
                                                        </div>
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Umur</label>
                                                            <input type="text" name="ternaks[<?php echo e($indukDetail->id); ?>][umur_ternak]" value="<?php echo e(old('ternaks.'.$indukDetail->id.'.umur_ternak', $indukDetail->umur_saat_dicatat)); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                        </div>
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Kondisi</label>
                                                            <select name="ternaks[<?php echo e($indukDetail->id); ?>][kondisi_ternak]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                <option value="Sehat" <?php echo e(old('ternaks.'.$indukDetail->id.'.kondisi_ternak', $indukDetail->kondisi_ternak) == 'Sehat' ? 'selected' : ''); ?>>Sehat</option>
                                                                <option value="Sakit" <?php echo e(old('ternaks.'.$indukDetail->id.'.kondisi_ternak', $indukDetail->kondisi_ternak) == 'Sakit' ? 'selected' : ''); ?>>Sakit</option>
                                                                <option value="Mati" <?php echo e(old('ternaks.'.$indukDetail->id.'.kondisi_ternak', $indukDetail->kondisi_ternak) == 'Mati' ? 'selected' : ''); ?>>Mati</option>
                                                                <option value="Terjual" <?php echo e(old('ternaks.'.$indukDetail->id.'.kondisi_ternak', $indukDetail->kondisi_ternak) == 'Terjual' ? 'selected' : ''); ?>>Terjual</option>
                                                            </select>
                                                        </div>
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Status Vaksin</label>
                                                            <select name="ternaks[<?php echo e($indukDetail->id); ?>][status_vaksin]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                <option value="Sudah" <?php echo e(old('ternaks.'.$indukDetail->id.'.status_vaksin', $indukDetail->status_vaksin) == 'Sudah' ? 'selected' : ''); ?>>Sudah</option>
                                                                <option value="Belum" <?php echo e(old('ternaks.'.$indukDetail->id.'.status_vaksin', $indukDetail->status_vaksin) == 'Belum' ? 'selected' : ''); ?>>Belum</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="anakContainer-<?php echo e($group['group_index']); ?>" class="space-y-3">
                                                    <?php $__currentLoopData = $anakDetailsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anakDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="anak-section" id="existing-detail-<?php echo e($anakDetail->id); ?>">
                                                        <div class="flex justify-between items-center mb-3">
                                                            <h4 class="text-sm font-semibold text-gray-800">Data Anak Ternak</h4>
                                                            <button type="button" onclick="removeExistingDetail('<?php echo e($anakDetail->id); ?>')" class="text-red-500 hover:text-red-700 transition-colors">
                                                                <i class="fas fa-times"></i> Hapus
                                                            </button>
                                                        </div>
                                                        <input type="hidden" name="ternaks[<?php echo e($anakDetail->id); ?>][detail_id]" value="<?php echo e($anakDetail->id); ?>">
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">Tipe Ternak</label>
                                                                <select name="ternaks[<?php echo e($anakDetail->id); ?>][tipe_ternak]" class="tipe-ternak-select mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                    <option value="Induk" <?php echo e($anakDetail->ternak->tipe_ternak == 'Induk' ? 'selected' : ''); ?>>Induk</option>
                                                                    <option value="Anak" <?php echo e($anakDetail->ternak->tipe_ternak == 'Anak' ? 'selected' : ''); ?>>Anak</option>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">Jenis Kelamin</label>
                                                                <select name="ternaks[<?php echo e($anakDetail->id); ?>][jenis_kelamin]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                    <option value="Jantan" <?php echo e($anakDetail->ternak->jenis_kelamin == 'Jantan' ? 'selected' : ''); ?>>Jantan</option>
                                                                    <option value="Betina" <?php echo e($anakDetail->ternak->jenis_kelamin == 'Betina' ? 'selected' : ''); ?>>Betina</option>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">No Ear Tag</label>
                                                                <select name="ternaks[<?php echo e($anakDetail->id); ?>][no_ear_tag]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                    <option value="Ada" <?php echo e($anakDetail->ternak->no_ear_tag == 'Ada' ? 'selected' : ''); ?>>Ada</option>
                                                                    <option value="Tidak Ada" <?php echo e($anakDetail->ternak->no_ear_tag == 'Tidak Ada' ? 'selected' : ''); ?>>Tidak Ada</option>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">Umur</label>
                                                                <input type="text" name="ternaks[<?php echo e($anakDetail->id); ?>][umur_ternak]" value="<?php echo e(old('ternaks.'.$anakDetail->id.'.umur_ternak', $anakDetail->umur_saat_dicatat)); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">Kondisi</label>
                                                                <select name="ternaks[<?php echo e($anakDetail->id); ?>][kondisi_ternak]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                    <option value="Sehat" <?php echo e(old('ternaks.'.$anakDetail->id.'.kondisi_ternak', $anakDetail->kondisi_ternak) == 'Sehat' ? 'selected' : ''); ?>>Sehat</option>
                                                                    <option value="Sakit" <?php echo e(old('ternaks.'.$anakDetail->id.'.kondisi_ternak', $anakDetail->kondisi_ternak) == 'Sakit' ? 'selected' : ''); ?>>Sakit</option>
                                                                    <option value="Mati" <?php echo e(old('ternaks.'.$anakDetail->id.'.kondisi_ternak', $anakDetail->kondisi_ternak) == 'Mati' ? 'selected' : ''); ?>>Mati</option>
                                                                    <option value="Terjual" <?php echo e(old('ternaks.'.$anakDetail->id.'.kondisi_ternak', $anakDetail->kondisi_ternak) == 'Terjual' ? 'selected' : ''); ?>>Terjual</option>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-700">Status Vaksin</label>
                                                                <select name="ternaks[<?php echo e($anakDetail->id); ?>][status_vaksin]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500 text-xs">
                                                                    <option value="Sudah" <?php echo e(old('ternaks.'.$anakDetail->id.'.status_vaksin', $anakDetail->status_vaksin) == 'Sudah' ? 'selected' : ''); ?>>Sudah</option>
                                                                    <option value="Belum" <?php echo e(old('ternaks.'.$anakDetail->id.'.status_vaksin', $anakDetail->status_vaksin) == 'Belum' ? 'selected' : ''); ?>>Belum</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php if($group['type'] === 'orphan'): ?>
                                        <div class="bg-white shadow rounded-lg ternak-group mb-4">
                                            ...
                                            <div class="p-6">
                                                <?php $__currentLoopData = $group['anak']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anakDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="anak-section" id="existing-detail-<?php echo e($anakDetail->id); ?>" style="border-left-color: #f97316;">
                                                    <div class="flex justify-between items-center mb-3">
                                                        <h4 class="text-sm font-semibold text-gray-800">Data Anak Ternak</h4>
                                                        <button type="button" onclick="removeExistingDetail('<?php echo e($anakDetail->id); ?>')" class="text-red-500 hover:text-red-700 transition-colors">
                                                            <i class="fas fa-times"></i> Hapus
                            ...
                            <div class="section-card bg-white rounded-lg shadow-md p-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="temuan_lapangan" name="temuan_lapangan" rows="4"
                                        ...
                                        placeholder="Deskripsikan kondisi kandang, kesehatan ternak, dan temuan lainnya..."><?php echo e(old('temuan_lapangan', $pencatatan->temuan_lapangan)); ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sticky top-6 space-y-6">
                                <div class="bg-white shadow-md rounded-lg p-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div id="photoPreviewGrid" class="<?php echo e($pencatatan->foto_dokumentasi && count($pencatatan->foto_dokumentasi) > 0 ? '' : 'hidden'); ?>">
                                            ...
                                            <div id="previewContainer" class="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto p-1">
                                                ...
                                                <?php if($pencatatan->foto_dokumentasi && count($pencatatan->foto_dokumentasi) > 0): ?>
                                                    <?php $__currentLoopData = $pencatatan->foto_dokumentasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="relative group photo-preview-item">
                                                        <img src="<?php echo e(asset('storage/' . $foto)); ?>" 
                                                             class="w-full h-20 object-cover rounded border" 
                                                             alt="Dokumentasi <?php echo e($index + 1); ?>">
                                                        <input type="hidden" name="existing_photos[]" value="<?php echo e($foto); ?>">
                                                        <button type="button" 
                                ...
                                <div class="bg-white shadow-md rounded-lg p-6">
                                    ...
                                    <div class="flex flex-col gap-3 pt-4 border-t border-gray-200">
                                        ...
                                        <a href="<?php echo e(route('pencatatan.index')); ?>"
                                            onclick="window.location.assign('<?php echo e(route('pencatatan.index')); ?>'); return false;"
        ...
        function removeExistingDetail(detailId) {
            Swal.fire({
                ...
                text: 'Apakah Anda yakin ingin menghapus anak ternak ini ini? Data master ternak ini akan dinonaktifkan.',
                icon: 'warning', // Memberi ikon peringatan
        ...
        function removeExistingPhoto(button) {
            if (confirm('Apakah Anda yakin ingin menghapus foto ini dari catatan?')) {
        ...
        function clearAllPhotos() {
            if (confirm('Yakin ingin menghapus semua foto baru yang dipilih/diambil?')) {
                selectedFiles = [];
                capturedPhotos = [];
                updateAllUI();
            }
...
<?php endif; ?><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/petugas/pencatatan-edit.blade.php ENDPATH**/ ?>