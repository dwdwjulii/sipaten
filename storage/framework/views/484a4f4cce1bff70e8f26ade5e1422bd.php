                        ...
                        <div x-data="{ open: false }" class="relative inline-block text-left">
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                ...
                                <ul class="max-h-52 overflow-y-auto text-sm text-gray-700">
                                    ...
                                    <li class="border-t border-gray-100 sticky bottom-0 bg-white">
                    ...
                    <table class="min-w-full text-xs text-gray-600 border border-gray-200">
                        <thead class="bg-gray-100 text-gray-500 text-sm">
                            <tr>
                                ...
                                <th class="px-2 py-3 border border-gray-200 text-left">Total Harga Induk</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="w-[4%] px-2 py-3 border border-gray-100 text-center">
                                    <?php echo e($loop->iteration + ($anggotas->currentPage() - 1) * $anggotas->perPage()); ?>

                                </td>
                                <td class="px-2 py-3 border border-gray-100 text-left truncate max-w-[250px]"
                                    title="<?php echo e($anggota->nama); ?>">
                                    <?php echo e($anggota->nama); ?>

                                </td>
                                <td class="w-[6%] px-2 py-3 border border-gray-100 text-center">
                                ...
                                <td class="w-[9%] px-2 py-3 border border-gray-100  text-center">
                                    <?php echo e($anggota->jumlah_induk); ?>

                                </td>
                                <td class="w-[14%] px-2 py-3 border border-gray-100 text-left">
                                    Rp <?php echo e(number_format($anggota->total_harga_induk, 0, ',', '.')); ?>

                                </td>
                                <td class="w-[10%] px-2 py-3 border  border-gray-100 text-center">
...
<?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/anggota.blade.php ENDPATH**/ ?>