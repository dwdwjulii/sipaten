...
<?php foreach($attributes->onlyProps(['anggota']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['anggota']); ?>
<?php foreach (array_filter((['anggota']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal-base','data' => ['title' => 'Detail Anggota','maxWidth' => 'lg','scrollable' => true,'showTitle' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Anggota','maxWidth' => 'lg','scrollable' => true,'showTitle' => true]); ?>
    ...
    <div class="space-y-6">
                ...
                <div class="flex-shrink-0">
                    <div
                        ...
                        <span class="text-2xl font-bold text-white">
                            <?php echo e(strtoupper(substr($anggota->nama, 0, 1))); ?>

                        </span>
                    </div>
                </div>
                <div class="flex-1 min-w-0">
                    <h2 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($anggota->nama); ?></h2>
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="text-sm text-gray-900 text-right">
                            ...
                            <?php echo e(\Carbon\Carbon::parse($anggota->tanggal_lahir)->format('d F Y')); ?>

                        </span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-medium text-gray-500">No. HP</span>
                        <span class="text-sm text-gray-900"><?php echo e($anggota->no_hp); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-medium text-gray-500">Tahap</span>
                        <span class="text-sm font-semibold text-blue-600"><?php echo e($anggota->tahap->label ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-5">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-medium text-gray-900 capitalize"><?php echo e($anggota->jenis_ternak); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-medium text-gray-500">Jumlah Induk</span>
                        <span class="text-sm font-bold text-green-600"><?php echo e($anggota->ternaks->where('tipe_ternak', 'Induk')->count()); ?> ekor</span>
                    </div>
                    <div class="flex justify-between items-start">
                        <span class="text-sm font-medium text-gray-500">Lokasi Kandang</span>
                        <span class="text-sm text-gray-900 text-right max-w-32"><?php echo e($anggota->lokasi_kandang); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-5">
            ...
            <?php if($anggota->ternaks->count()): ?>
            <div class="space-y-2 mb-4">
                <?php $__currentLoopData = $anggota->ternaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ternak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                            <span class="text-sm font-semibold text-blue-600"><?php echo e($index + 1); ?></span>
                        </div>
                        <span class="text-sm font-medium text-gray-700">Induk <?php echo e($index + 1); ?></span>
                    </div>
                    <div class="text-right">
                        <span class="text-base font-bold text-gray-900">
                            Rp <?php echo e(number_format($ternak->harga, 0, ',', '.')); ?>

                        </span>
                        <?php if($ternak->kode_eartag): ?>
                        <div class="text-xs text-gray-500"><?php echo e($ternak->kode_eartag); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 pt-4">
                <div
                    ...
                    <div>
                        ...
                        <div class="text-xs text-gray-500"><?php echo e($anggota->ternaks->count()); ?> ekor induk ternak</div>
                    </div>
                    <div class="text-right">
                        <span class="text-xl font-bold text-blue-600">
                            Rp <?php echo e(number_format($anggota->ternaks->sum('harga'), 0, ',', '.')); ?>
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4">
            <div class="flex items-center justify-between text-xs text-gray-600">
                <span>Dibuat: <?php echo e(\Carbon\Carbon::parse($anggota->created_at)->format('d M Y H:i')); ?></span>
                <span>Diperbarui: <?php echo e(\Carbon\Carbon::parse($anggota->updated_at)->format('d M Y H:i')); ?></span>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Dewa Juli\Documents\My Project\Proyek Sipaten\sipaten\resources\views/components/anggota/detail-modal.blade.php ENDPATH**/ ?>