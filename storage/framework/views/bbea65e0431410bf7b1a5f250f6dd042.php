    ...
    <form method="POST" action="<?php echo e(route('pengguna.update', $user)); ?>" class="space-y-3">
        ...
        <div class="grid grid-cols-4 gap-3">
            ...
            <div class="col-span-3 relative" x-data="{ show: false }">
                <label class="block text-xs font-medium text-gray-800">Password (kosongkan jika tidak diubah)</label>
                <input 
                    :type="show ? 'text' : 'password'" 
                    name="password"
                    class="mt-1 block w-full rounded-md text-gray-800 placeholder-gray-800 border-gray-200 focus:ring-0 focus:ring-green-500 focus:border-green-500 text-xs pr-8"
                    placeholder="••••••••"
                >
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Dewa Juli\Documents\My Project\Proyek Sipaten\sipaten\resources\views/components/pengguna/edit-modal.blade.php ENDPATH**/ ?>