            ...
            <div class="max-h-[90vh] overflow-y-auto scrollbar-hide px-8 py-6 space-y-8">
                ...
                <div class="bg-white border rounded-xl p-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-700 leading-relaxed"><?php echo e($pencatatan->temuan_lapangan ?? 'Tidak ada catatan temuan.'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-4 border border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold"><?php echo e($pencatatan->petugas?->name ?? 'Belum ada petugas'); ?></p>
                    </div>
                </div>
                                    ...
                                    <?php if($anakYatimDetails->isNotEmpty()): ?>
                                        ...
                                        <?php $__currentLoopData = $anakYatimDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yatimDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-amber-50 transition-colors">
                                                ...
                                                <td class="px-4 py-3">
                                                    <span class="inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
...
</div><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/components/pencatatan/detail-modal.blade.php ENDPATH**/ ?>