...
<div x-data="{ open: false }">
    ...
    <button @click="open = true" type="button"
        class="w-full inline-flex items-center px-3 py-2 text-green-600 hover:bg-green-100 hover:rounded-b-md font-medium text-xs">
    ...
    <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        ...
        <div @click.away="open = false" class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <form method="POST" action="<?php echo e(route('tahap.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label class="block text-xs font-medium text-gray-600">Tahap</label>
...
</div><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/components/anggota/tahap-modal.blade.php ENDPATH**/ ?>