            ...
            <div>
                <p class="text-sm mt-2 text-gray-800 dark:text-gray-200">
                    ...
                    <button form="send-verification"
                        class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'bg-blue-600 hover:bg-blue-700 focus:ring-1 focus:ring-offset-2 focus:ring-blue-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-blue-600 hover:bg-blue-700 focus:ring-1 focus:ring-offset-2 focus:ring-blue-500']); ?>
...
</section><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>