    ...
    <form method="POST" action="<?php echo e(route('pengguna.store')); ?>" class="space-y-3" x-ref="formCreatePengguna">
        ...
        <div>
            ...
            <input type="text" name="name"
                class="mt-1 block w-full rounded-md border-gray-200 text-gray-800  placeholder-gray-500 focus:ring-0 focus:border-green-500 text-xs"
        ...
        <div class="grid grid-cols-4 gap-3">
            <div class="col-span-3">
                ...
                <input type="email" name="email"
                    class="mt-1 block w-full rounded-md text-gray-800 placeholder-gray-500 border-gray-200 focus:ring-0 focus:border-green-500 text-xs"
...
<?php endif; ?>
<?php $__env->stopPush(); ?><?php /**PATH C:\MAHENDRA\Project\sipaten\resources\views/components/pengguna/create-modal.blade.php ENDPATH**/ ?>