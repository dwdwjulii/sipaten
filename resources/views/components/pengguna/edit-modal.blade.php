...
<x-modal-base title="Edit Pengguna" maxWidth="md" :scrollable="false" :showTitle="true">
    ...
    <form method="POST" action="{{ route('pengguna.update', $user) }}" class="space-y-3">
        ...
        {{-- Password + Status --}}
        <div class="grid grid-cols-4 gap-3">
            {{-- Password dengan Toggle AlpineJS + Strength Meter --}}
            <div class="col-span-3 relative" x-data="{ show: false, strength: 0, strengthText: '', strengthColor: '' }">
                ...
                <div class="relative">
                    <input 
                        ...
                        name="password"
                        class="mt-1 block w-full pr-10 rounded-md text-gray-800 placeholder-gray-800 border-gray-200 focus:ring-0 focus:ring-green-500 focus:border-green-500 text-xs"
                        placeholder="••••••••"
                        @input="
