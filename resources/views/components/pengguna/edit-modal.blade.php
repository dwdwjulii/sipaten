{{-- File: resources/views/components/pengguna/edit-modal.blade.php --}}
@props(['user'])

<x-modal-base title="Edit Pengguna" maxWidth="md" :scrollable="false" :showTitle="true">
    ...
    {{-- Form Edit Pengguna --}}
    <form method="POST" action="{{ route('pengguna.update', $user) }}" class="space-y-3">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-4 gap-3">
            ...
            {{-- Dropdown Role --}}
            <div x-data="{ open: false, selected: '{{ old('role', $user->role) }}' }" class="relative col-span-1">
        ...
        {{-- Password + Status --}}
        <div class="grid grid-cols-4 gap-3">
            {{-- Password dengan Toggle AlpineJS --}}
            ...
            {{-- Dropdown Status --}}
            <div x-data="{ open: false, selected: '{{ old('status', $user->status) }}' }" class="relative col-span-1">
